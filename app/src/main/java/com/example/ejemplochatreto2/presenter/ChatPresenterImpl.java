...
public class ChatPresenterImpl implements ChatPresenter {
    ...
    public void loadConversations(UserModel user1, UserModel user2) {
        ...
        FirebaseFirestore.getInstance().collection("conversations")
                ...
                .addSnapshotListener((queryDocumentSnapshots, e) -> {
                    if (e != null) {
                        Log.e(ContentValues.TAG, "Error al cargar las conversaciones: ", e);
                        return;
                    }
        ...
        if (user1 != null && user2 != null) {
            ...
            messagesRef.add(message)
                    ...
                    .addOnFailureListener(e -> {
                        Log.e(ContentValues.TAG, "Error sending message: " + e.getMessage());
            ...
            Log.e(ContentValues.TAG, "User1 or User2 is null");
        }
    }
                    ...
                    for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                        ...
                        if (userFromFirestore != null) {
                            if (userFromFirestore.getUserId() != null) {
                                ...
                                Log.e(ContentValues.TAG, "userId is null for user: " + userFromFirestore.getEmail());
                            }
                        } else {
                            Log.e(ContentValues.TAG, "User not found in usuarios collection");
                        }
                    }
                })
                .addOnFailureListener(e -> {
                    Log.e(ContentValues.TAG, "Error getting user from usuarios collection: " + e.getMessage());
                });
    }
    ...
    private void updateUserData(String userId, String conversationId, String messageId) {
        FirebaseFirestore.getInstance().collection("usuarios").document(userId)
                ...
                .addOnSuccessListener(aVoid -> Log.d(ContentValues.TAG, "MessageId added to user"))
                .addOnFailureListener(e -> Log.e(ContentValues.TAG, "Error updating document: " + e.getMessage()));
    }
